public class PresidentApp {
    public static void main(String [] args)
    {
        President[] presidents = {
            new President("George Washington", "First President, led independence",95),
            new President("Abraham Lincoln","Led nation through Civil War, abolished slavery",98),
            new President("Franklin D. Roosovelt", "Guided nation through Great Depression and WWII",92)
        };
